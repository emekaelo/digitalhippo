...
const perks = [
    {
        ...
        description: "Get your assets delivered in seconds and get them right away"
    }, {
        ...
        name: "For the Planet",
        icon: Leaf,
        description: "With pledged 1% of sales to preservation and restoration of the environment"
    },
]
...
export default function Home() {
    return (<><MaxWidthWrapper>
      ...
      digital assets
                ...
                <p className="mt-3 text-lg max-w-prose text-muted-foreground">Welcome to DigitalHippo. Every asset on
                    our
                    platform is verified by our team to ensure our highest quality standards.</p>
